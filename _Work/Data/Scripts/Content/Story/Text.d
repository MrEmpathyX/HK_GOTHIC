...
{
	"",															//NPC_TALENT_UNKNOWN			= 0;
	  "1/3|2/3|3/3",									//NPC_TALENT_1H					= 1;
	  "1/3|2/3|3/3",									//NPC_TALENT_2H					= 2;
	"-",									//NPC_TALENT_BOW				= 3;
	"-",									//NPC_TALENT_CROSSBOW			= 4;
...
const string PRINT_XPGained				= "Punkty doœwiadczenia + ";			// bei jedem Erfahrungsgewinn
const string PRINT_LevelUp				= "Awansowa³eœ na kolejny poziom!";		// beim	Stufenaufstieg
const string PRINT_NewLogEntry			= "Nowy wpis w dzienniku";
const string PRINT_TeleportTooFarAway	= "To zbyt daleko";
